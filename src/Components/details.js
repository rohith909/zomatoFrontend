...
class Details extends React.Component {
    ...
    componentDidMount() {
        ...
        axios({
            url: `http://zomato-clone-9.herokuapp.com/restaurant/${restaurant}`,
            method: 'GET',
    ...
    handelOrder = () => {
        ...
        axios({
            url: `http://zomato-clone-9.herokuapp.com/menuitems/${restaurantId}`,
            method: 'GET',
            headers: { 'Content-Type': 'application/json' },
        })
            .then(response => {
    ...
    getData = (data) => {
        return fetch(`http://zomato-clone-9.herokuapp.com/payment`, {
            method: "POST",
            headers: {
    ...
    details = () => {
        ...
        axios({
            method: 'POST',
            url: 'http://zomato-clone-9.herokuapp.com/orders',
            headers: { 'Content-Type': 'application/json' },
            data: detailsObj
        })
            .then(response => {
