...
class Details extends React.Component {
    ...
    componentDidMount() {
        ...
        axios({
            url: `https://videoappchat.herokuapp.com/restaurant/${restaurant}`,
            method: 'GET',
    ...
    handelOrder = () => {
        ...
        axios({
            url: `https://videoappchat.herokuapp.com/menuitems/${restaurantId}`,
            method: 'GET',
            headers: { 'Content-Type': 'application/json' },
        })
            .then(response => {
    ...
    getData = (data) => {
        return fetch(`https://videoappchat.herokuapp.com/payment`, {
            method: "POST",
            headers: {
    ...
    details = () => {
        ...
        axios({
            method: 'POST',
            url: 'https://videoappchat.herokuapp.com/orders',
            headers: { 'Content-Type': 'application/json' },
            data: detailsObj
        })
            .then(response => {
